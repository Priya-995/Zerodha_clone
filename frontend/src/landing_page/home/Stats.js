            ...
            <div className="row">
                <div className="col-6">
                    ...
                    <p className="mb-4 text-muted">
                        That's why 1.3+ crore customers trust Zerodha with Rs.3.5+ lakh crores worth of equity investments.
                    </p>
                ...
                <div className="col-6">
                    ...
                    <div className="text-center">
                        <a href="#" className="mx-4 text-decoration-none">Explore our products <i className="fa-solid fa-arrow-right"></i></a>
